...
public class WfsFeatureType implements Serializable {
	...
	private String name; // name as in WFS capabilities, will be used as
							// filename
	private String extension; // extension of the filename, can be retrieved via
								// converter
	private String namespacePrefix; // e.g. "ps"
	private String namespaceUri; // e.g.
									// "urn:x-inspire:specification:gmlas:ProtectedSites:3.0"
	private String filterExpression; // expression to filter out sub type from
										// featuretype e.g. "EHS"
	private String serviceUrl; // url for post request to the wfs
	private String serviceVersion; // WFS version (needed for proper post
									// request)
	private String crs; // Crs code e.g. "urn:ogc:def:crs:EPSG::4258"
	private String wfsMimetype; // Mimetype to retrieve from the WFS e.g.
	...
	/**
	 * @return Mimetype to retrieve from the WFS e.g.
	 *         "application/gml+xml; version=3.1"
	 */
